                    ...
                    <div class="project-card clip" data-category="clip">
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                            <div class="relative h-64 overflow-hidden">
                                <iframe class="absolute inset-0 w-full h-full" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen :src="video.chemin_lien"></iframe>
                            </div>
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <button class="text-accent hover:underline view-details">Voir les détails</button>
                                </div>
                            </div>
                        </div>
                    </div>
